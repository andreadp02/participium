...
describe("authRepository", () => {
  ...
  describe("createUserWithRole", () => {
    it("creates user with role and select fields", async () => {
      ...
      const res = await authRepository.createUserWithRole(
        created.email,
        created.username,
        created.firstName,
        created.lastName,
  ...
  describe("getAllUsers", () => {
    it("returns all users", async () => {
      ...
      const res = await authRepository.getAllUsers();
  ...
  describe("deleteUser", () => {
    it("calls prisma.delete with given id and returns result", async () => {
      ...
      const res = await authRepository.deleteUser(5);
  ...
  describe("getUsersByRole", () => {
    it("calls prisma.findMany with provided Prisma role string and returns users", async () => {
      ...
      const res = await authRepository.getUsersByRole("MUNICIPALITY");
    ...
    it("accepts custom role value and forwards it to prisma (type-cast branch)", async () => {
      ...
      const res = await authRepository.getUsersByRole("ADMIN" as any);
